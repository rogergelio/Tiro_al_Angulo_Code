...
radar_output = radar.draw_radar_compare(fidalgo, richard, ax=axs['radar'],
...
endnote_text = axs['endnote'].text(0.99, 0.5, 'Rogelio Torres | Tiro al Ángulo', 
                                   fontproperties=robotto_thin.prop, ha='right', va='center', fontsize=15, color="#ffffff")
title1_text = axs['title'].text(0.01, 0.85, 'Álvaro Fidalgo',  color='#def200',
                                fontproperties=robotto_bold.prop, ha='left', va='center', fontsize=25)
title2_text = axs['title'].text(0.01, 0.25, 'Club América', 
                                fontproperties=robotto_thin.prop,
                                ha='left', va='center', color='#def200', fontsize=20,)
title3_text = axs['title'].text(0.99, 0.85, 'Richard Sánchez', 
                                fontproperties=robotto_bold.prop,
                                ha='right', va='center', color='#5e5eff',fontsize=25)
title4_text = axs['title'].text(0.99, 0.25, 'Club América', 
                                fontproperties=robotto_thin.prop,
