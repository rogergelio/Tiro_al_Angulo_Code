...
radar_output = radar.draw_radar_compare(rl, fs, ax=axs['radar'],
                                        kwargs_radar={'facecolor': '#0066e7', 'alpha': 0.6},
                                        kwargs_compare={'facecolor': '#39ff14', 'alpha': 0.6})
...
title1_text = axs['title'].text(0.01, 0.85, 'Fernando Sobral',  color='#39ff14',
                                fontproperties=robotto_bold.prop, ha='left', va='center', fontsize=25)
title2_text = axs['title'].text(0.01, 0.25, 'Cuiabá', 
                                fontproperties=robotto_thin.prop,
                                ha='left', va='center', color='#39ff14', fontsize=20,)
title3_text = axs['title'].text(0.99, 0.85, 'Rodrigo López', 
                                fontproperties=robotto_bold.prop,
                                ha='right', va='center', color='#0066e7',fontsize=25)
title4_text = axs['title'].text(0.99, 0.25, 'Querétaro', 
                                fontproperties=robotto_thin.prop,
                                ha='right', va='center', color='#0066e7', fontsize=20)
fig
